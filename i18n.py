...
STR = {
    ...
    "tab_jokes":        {"uk": "Жарти", "ru": "Шутки", "en": "Jokes"},
    "jokes_title":      {"uk": "Жарти під час стиснення", "ru": "Шутки во время сжатия",
                         "en": "Jokes shown while compressing"},
    "jokes_hint":       {"uk": "Свої жарти падають у ротацію. Вбудовані про навоз видалити не можна 🐮 (тільки свої).",
                         "ru": "Свои шутки попадают в ротацию. Встроенные про навоз удалить нельзя 🐮 (только свои).",
                         "en": "Your jokes join the rotation. Built-in jokes can't be deleted 🐮 (only yours)."},
    "jokes_add":        {"uk": "Додати", "ru": "Добавить", "en": "Add"},
    "jokes_del":        {"uk": "Видалити свій", "ru": "Удалить свою", "en": "Delete yours"},
    "jokes_count":      {"uk": "🐮 {builtin} вбудованих + {custom} своїх",
                         "ru": "🐮 {builtin} встроенных + {custom} своих",
                         "en": "🐮 {builtin} built-in + {custom} yours"},
