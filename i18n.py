...
STR = {
    ...
    "opt_sound":        {"uk": "Звук «готово» після стиснення (140+ випадкових)",
                         "ru": "Звук «готово» после сжатия (140+ случайных)",
                         "en": "Play a sound when done (140+ random)"},
    ...
    "jokes_hint":       {"uk": "Свої жарти падають у ротацію. Будь-який можна видалити (навіть вбудований).",
                         "ru": "Свои шутки попадают в ротацию. Любую можно удалить (даже встроенную).",
                         "en": "Your jokes join the rotation. Any can be deleted (even built-in)."},
    "jokes_add":        {"uk": "Додати", "ru": "Добавить", "en": "Add"},
    "jokes_del":        {"uk": "Видалити вибране", "ru": "Удалить выбранное", "en": "Delete selected"},
    "jokes_ph":         {"uk": "Напиши свій жарт…", "ru": "Напиши свою шутку…", "en": "Type your joke…"},
    "jokes_count":      {"uk": "Усього жартів: {n}", "ru": "Всего шуток: {n}", "en": "Total jokes: {n}"},
