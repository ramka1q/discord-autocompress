...
STR = {
    ...
    "opt_sound":        {"uk": "Звук «готово» після стиснення",
                         "ru": "Звук «готово» после сжатия",
                         "en": "Play a sound when compression is done"},
    "ov_saved":         {"uk": "зекономлено {pct}%", "ru": "сэкономлено {pct}%", "en": "saved {pct}%"},
    "tab_facts":        {"uk": "Факти", "ru": "Факты", "en": "Facts"},
    "facts_title":      {"uk": "Цікаві факти про програму", "ru": "Интересные факты о программе",
                         "en": "Interesting facts about the app"},
    "facts_hint":       {"uk": "Ці факти показуються під час стиснення, щоб скоротати очікування.",
                         "ru": "Эти факты показываются во время сжатия, чтобы скоротать ожидание.",
                         "en": "These facts are shown while compressing to pass the wait."},
    # ---- статистика / історія ----
    "tab_stats":        {"uk": "Статистика", "ru": "Статистика", "en": "Stats"},
    "stats_title":      {"uk": "Твоя статистика", "ru": "Твоя статистика", "en": "Your stats"},
    "stats_since":      {"uk": "Разом з тобою з {d} 💙", "ru": "Вместе с тобой с {d} 💙", "en": "With you since {d} 💙"},
    "stats_files":      {"uk": "файлів стиснуто", "ru": "файлов сжато", "en": "files compressed"},
    "stats_saved":      {"uk": "місця зекономлено", "ru": "места сэкономлено", "en": "space saved"},
    "stats_avg":        {"uk": "середнє стиснення", "ru": "среднее сжатие", "en": "avg compression"},
    "stats_hist":       {"uk": "Останні стиснення", "ru": "Последние сжатия", "en": "Recent compressions"},
    "stats_hint":       {"uk": "Обери рядок — файл можна скопіювати знову і одразу вставити в Discord (без повторного стиснення).",
                         "ru": "Выбери строку — файл можно скопировать снова и сразу вставить в Discord (без повторного сжатия).",
                         "en": "Pick a row — copy the file again and paste it into Discord (no re-compression)."},
    "stats_copy":       {"uk": "📋 Скопіювати знову", "ru": "📋 Скопировать снова", "en": "📋 Copy again"},
    "stats_open":       {"uk": "📂 Показати в папці", "ru": "📂 Показать в папке", "en": "📂 Show in folder"},
    "stats_clear":      {"uk": "🧹 Очистити історію", "ru": "🧹 Очистить историю", "en": "🧹 Clear history"},
    "stats_copied":     {"uk": "Скопійовано ✓ — тисни Ctrl+V у Discord", "ru": "Скопировано ✓ — жми Ctrl+V в Discord", "en": "Copied ✓ — press Ctrl+V in Discord"},
    "stats_gone":       {"uk": "Цього файла вже немає на ПК", "ru": "Этого файла уже нет на ПК", "en": "This file is no longer on the PC"},
    "stats_empty":      {"uk": "Тут з'являтиметься історія твоїх стиснень 💙\nСтисни перше відео — і побачиш.",
                         "ru": "Здесь будет история твоих сжатий 💙\nСожми первое видео — и увидишь.",
                         "en": "Your compression history will appear here 💙\nCompress your first video to see it."},
    "stats_parts":      {"uk": "частин", "ru": "частей", "en": "parts"},
    "unit_gb":          {"uk": "ГБ", "ru": "ГБ", "en": "GB"},
    "ov_total_saved":   {"uk": "Разом зекономлено вже {tot} 💙", "ru": "Всего сэкономлено уже {tot} 💙", "en": "Total saved so far: {tot} 💙"},
    "ov_milestone":     {"uk": "🎉 Ювілей! Уже {tot} зекономлено разом", "ru": "🎉 Юбилей! Уже {tot} сэкономлено вместе", "en": "🎉 Milestone! {tot} saved together"},

    "sound_pick":       {"uk": "Обрати свій звук…", "ru": "Выбрать свой звук…", "en": "Choose sound…"},
    "sound_win":        {"uk": "Звук Windows", "ru": "Звук Windows", "en": "Windows sound"},
    "sound_custom":     {"uk": "свій звук ✓", "ru": "свой звук ✓", "en": "custom ✓"},
    "sound_windows":    {"uk": "звук Windows", "ru": "звук Windows", "en": "Windows sound"},
    ...
    "update_hint":      {"uk": "Оновлення лише тут: натисни кнопку — програма перевірить і скачає нову версію.",
                         "ru": "Обновление только здесь: нажми кнопку — программа проверит и скачает новую версию.",
                         "en": "Updates happen only here: press the button to check and download a new version."},
    ...
    "ov_custom_type":   {"uk": "Свій розмір: скільки МБ? (від {min} до {max})",
                         "ru": "Свой размер: сколько МБ? (от {min} до {max})",
                         "en": "Custom size: how many MB? (from {min} to {max})"},
    "ov_custom_low":    {"uk": "Не менше {min} МБ — це твій ліміт у налаштуваннях",
                         "ru": "Не меньше {min} МБ — это твой лимит в настройках",
                         "en": "Not below {min} MB — that's your limit in settings"},
    "ov_custom_hint":   {"uk": "натисни ✏, щоб задати свій розмір",
                         "ru": "нажми ✏, чтобы задать свой размер",
                         "en": "click ✏ to set a custom size"},
