...
FACTS = {
    "uk": [
        ...
        "Вбудований редактор має справжній таймлайн із хвилею звуку і накладками.",
    ...
    "ru": [
        ...
        "Встроенный редактор — настоящий таймлайн со звуковой волной и накладками.",
    ...
    "en": [
        ...
        "The built-in editor has a real timeline with an audio waveform and overlays.",
